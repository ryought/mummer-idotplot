...
def main():
    import argparse
    parser = argparse.ArgumentParser(description='mummer-idotplot: Mummer Interactive Dotplot Generator')
    ...
    parser.add_argument('--refs', required=True, nargs='+', help='list of sequence ids of reference')
